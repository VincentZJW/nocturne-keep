...
const OUTPUT_ROOT: String = "res://chapters/chapter_01_ravenmourn_outskirts/assets/enemies/castle_guard"
const CONTACT_SHEET_PATH: String = "res://docs/qa/castle_guard_animation_sheet.png"
const REFERENCE_PATH: String = (
	"res://chapters/chapter_01_ravenmourn_outskirts/assets/enemies/castle_guard/reference/cursed_castle_guard_reference.png"
)
