...
func _test_scaled_configs() -> void:
	var guard: CastleGuardConfig = load("res://chapters/chapter_01_ravenmourn_outskirts/resources/enemies/castle_guard_config.tres") as CastleGuardConfig
	var shield: CursedShieldGuardConfig = load("res://shared/resources/enemies/cursed_shield_guard_config.tres") as CursedShieldGuardConfig
	var spear: DecayedSpearmanConfig = load("res://chapters/chapter_01_ravenmourn_outskirts/resources/enemies/decayed_spearman_config.tres") as DecayedSpearmanConfig
	var crossbow: FallenCrossbowmanConfig = load("res://shared/resources/enemies/fallen_crossbowman_config.tres") as FallenCrossbowmanConfig
	var gargoyle: GargoyleSentinelConfig = load("res://shared/resources/enemies/gargoyle_sentinel_config.tres") as GargoyleSentinelConfig
	var boss: FallenGateKnightConfig = load("res://chapters/chapter_01_ravenmourn_outskirts/resources/boss/fallen_gate_knight_config.tres") as FallenGateKnightConfig
...
func _test_boss_reward(main: Node2D) -> void:
	...
	var threshold: Node2D = load("res://chapters/chapter_01_ravenmourn_outskirts/scenes/transitions/ravenmourn_threshold.tscn").instantiate() as Node2D
