...
Entrance: `Main/CastleEntranceTransition` performs a 0.55-second text-free fade and loads `res://chapters/chapter_01_ravenmourn_outskirts/scenes/transitions/ravenmourn_threshold.tscn`, an art-only interior placeholder with no Label nodes and no second-level combat.
