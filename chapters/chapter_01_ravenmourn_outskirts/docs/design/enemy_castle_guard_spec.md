...
`res://chapters/chapter_01_ravenmourn_outskirts/scenes/level/ravenmourn_outskirts.tscn` owns four mixed groups under `World/Encounters` and three saved instances of this scene:
