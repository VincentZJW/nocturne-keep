...
func _draw() -> void:
	draw_rect(Rect2(0, -180, BALLROOM_WIDTH, 792), Color("100d18"), true)
	# Mirror bays and pillars stay behind actors.
	for index: int in range(6):
		var x: float = 190.0 + float(index) * 610.0
	...
	for index: int in range(10):
		var x: float = 150.0 + float(index) * 375.0
	...
	draw_line(Vector2(0, 540), Vector2(BALLROOM_WIDTH, 540), Color("53435f"), 4.0)
	for x: int in range(0, int(BALLROOM_WIDTH), 96):
