...
@export var arena_left_offset: float = -3020.0
@export var arena_right_offset: float = 1120.0
...
@export var phase_2_entry_gap: float = 0.72
...
@export var phase_2_min_attack_gap: float = 0.72
@export var phase_2_max_attack_gap: float = 0.90
...
@export var phase_transition_duration: float = 1.22
...
@export_range(1, 20, 1) var double_lunge_damage_1: int = 9
@export_range(1, 20, 1) var double_lunge_damage_2: int = 12
...
@export_range(1, 20, 1) var phantom_damage: int = 10
...
@export_range(1, 20, 1) var final_waltz_damage: int = 8
