...
func _encounter_definitions() -> Array[Dictionary]:
	return [
		...
		{"id": "EncounterE06", "floor": 1, "center": Vector2(5880, 612), "spawns": [_spawn(RETAINER, "HollowRetainer", Vector2(5600, 612)), _spawn(HALBERDIER, "CourtHalberdier", Vector2(5880, 612)), _spawn(SHIELD_GUARD, "CursedShieldGuard", Vector2(6120, 612))]},
		...
		{"id": "EncounterE12", "floor": 2, "center": Vector2(1010, -288), "spawns": [_spawn(RETAINER, "HollowRetainer", Vector2(900, -288)), _spawn(HALBERDIER, "CourtHalberdier", Vector2(1120, -288))]},
