...
const CAPTURES: Array[Dictionary] = [
	...
	{"file": "04_grand_service_stair.png", "position": Vector2(6580, 500), "limits": Vector2i(0, 720)},
	...
	{"file": "08_servant_side_stair.png", "position": Vector2(640, -360), "limits": Vector2i(-900, -180)},
