...
func _draw() -> void:
	draw_rect(Rect2(0, 0, 1800, 720), Color("080a10"), true)
	draw_rect(Rect2(0, 92, 1800, 520), Color("151823"), true)
	...
	for bell_index: int in range(13):
		var x: float = 270.0 + float(bell_index) * 108.0
		draw_arc(Vector2(x, 280), 16.0, PI, TAU, 18, Color(0.56, 0.59, 0.66, 0.7), 3.0)
	draw_rect(Rect2(0, 612, 1800, 108), Color("252832"), true)
	draw_line(Vector2(0, 612), Vector2(1800, 612), Color("777b87"), 3.0)
