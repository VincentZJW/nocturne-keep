...
Player has 100 Health, normal Attack deals 1, and Dash Attack deals 2. Pure damage math therefore gives normal/Dash kill counts of 3/2, 7/4, 5/3, and 4/2 respectively. A frontal Shield Guard requires a prior Dash Attack GuardBreak, so an all-frontal Dash sequence requires at least five inputs: one consumed break plus four damaging hits. Full-Health Player lethal-hit counts are 20 / 13 / 10 / 17; equivalently the Player survives 19 / 12 / 9 / 16 prior hits. These are gray-box values, not final balance.
