...
## Owns the text-free fade from the opened Main gate into a placeholder threshold scene.

signal transition_started
signal transition_completed

@export_file("*.tscn") var target_scene_path: String = "res://scenes/transitions/ravenmourn_threshold.tscn"
