...
const Generator: Script = preload("res://scripts/tools/pixel_castle_guard_generator.gd")
const SpriteFramesBuilder: Script = preload("res://scripts/tools/castle_guard_sprite_frames_builder.gd")
