...
const CASTLE_SCENE: PackedScene = preload("res://scenes/enemies/castle_guard.tscn")
...
func _test_config_values_and_unchanged_cadence() -> void:
	var castle: CastleGuardConfig = load(
		"res://resources/enemies/castle_guard_config.tres"
...
func _test_scene_value_authority() -> void:
	for path: String in [
		"res://scenes/enemies/castle_guard.tscn",
		"res://scenes/enemies/cursed_shield_guard.tscn",
		"res://scenes/enemies/decayed_spearman.tscn",
		"res://scenes/enemies/fallen_crossbowman.tscn",
	]:
	...
	_expect(
		not FileAccess.get_file_as_string(
			"res://scenes/projectiles/crossbow_bolt.tscn"
		).contains("\ndamage ="),
